MariaDB [(none)]> CREATE DATABASE CollegeDB;
Query OK, 1 row affected (0.000 sec)

MariaDB [(none)]> USE CollegeDB;
Database changed
MariaDB [CollegeDB]> 
MariaDB [CollegeDB]> CREATE TABLE Employees (
...
MariaDB [CollegeDB]> 
MariaDB [CollegeDB]> CREATE TABLE Departments (
...
MariaDB [CollegeDB]> 
MariaDB [CollegeDB]> CREATE TABLE Projects (
...
MariaDB [CollegeDB]> 
MariaDB [CollegeDB]> INSERT INTO Employees (EmpID, FirstName, LastName, DepartmentID)
    -> VALUES
    -> (1, 'Alice', 'Johnson', 101),
    -> (2, 'Bob', 'Smith', 102),
    -> (3, 'Charlie', 'Brown', 103),
...
MariaDB [CollegeDB]> 
MariaDB [CollegeDB]> INSERT INTO Departments (DepartmentID, DeptName)
    -> VALUES
    -> (101, 'HR'),
    -> (102, 'IT'),
    -> (103, 'Finance'),
...
MariaDB [CollegeDB]> 
MariaDB [CollegeDB]> INSERT INTO Projects (ProjectID, ProjectName, DepartmentID)
    -> VALUES
...
MariaDB [CollegeDB]> 
MariaDB [CollegeDB]> ALTER TABLE Projects
    -> RENAME COLUMN DepartmentID TO DeptID;
Query OK, 0 rows affected (0.026 sec)
Records: 0  Duplicates: 0  Warnings: 0

MariaDB [CollegeDB]> 
MariaDB [CollegeDB]> ALTER TABLE Departments
    -> RENAME COLUMN DepartmentID TO DeptID;
Query OK, 0 rows affected (0.029 sec)
Records: 0  Duplicates: 0  Warnings: 0

MariaDB [CollegeDB]> 
MariaDB [CollegeDB]> SELECT CONCAT(FirstName, ' ', LastName) AS FullName,
    ->        DeptName,
    ->        ProjectName
    -> FROM Employees
